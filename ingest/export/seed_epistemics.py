...
QUESTIONS = [
    ...
    ('extract_scope_missing_log_observed_ids',
     ...
     'Absolute calibration completeness; Consecrated Holy Weapon\'s magnitude', 'open', None, '200818,20424,954923,907790,18652', '2026-08-05'),
