...
> **`SUPERSEDED BY primer/Session_2026-08-07_3j_integrity.md`** — the work order for
> session `3j`, drafted from `primer/AUDIT_3I_ADVERSARIAL.md` (§10 is the source list;
> this file orders and scopes it). `3j` ran and closed 2026-08-07; **read the session
> record for what was actually done, including the explicit list of what was not.**
