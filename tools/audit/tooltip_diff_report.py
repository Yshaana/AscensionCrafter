...
from config import DATA_DERIVED, DB_PATH as _DB_PATH, ensure_derived_dir  # noqa: E402

DB_PATH = str(_DB_PATH)
REPORT_MD = DATA_DERIVED / 'tooltip_diff_report.md'
REPORT_JSON = DATA_DERIVED / 'tooltip_diff_report.json'
