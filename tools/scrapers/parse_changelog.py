...
CHANGELOG_DIR = REPO / "data" / "source" / "changelog"
CATALOG = REPO / "index" / "spell-export.json"
ASCENSION_EXTRACT = REPO / "index" / "dbc-ascension-extract.json"
...
def load_zone_tokens():
    ...
    import gzip
    for path in (REPO / "data" / "source" / "crawl").glob("*/phases.jsonl.gz"):
        try:
